...
data <- BA_clm
data$MAT <- data$MAT+237
n <- nrow(data)

mean_MAP <- mean(BA_clm$MAP)
mean_MAT <- mean(BA_clm$MAT)

MAT_x <- seq(-5+237,30+237,(30-5)/100)
...
inits=list(list(mu1=300,tau1=1,a2=2,b2=1,int=0.01,sigma=0.1),list(mu1=300,tau1=1,a2=1.9,b2=1,int=0.01,sigma=0.1),list(mu1=300,tau1=1,a2=1.9,b2=1,int=0.01,sigma=0.1))
